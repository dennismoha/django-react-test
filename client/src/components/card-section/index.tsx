...
const PatientRecords: React.FC<{ patientRecords: PatientRecord[] }> = ({ patientRecords }) => {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-1 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16   pt-1 sm:mt-1 sm:pt-1 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {patientRecords.map((patient) => (
            <article key={patient.id} className="flex max-w-xl flex-col items-start justify-between">
              ...
              <div className="group relative">
                ...
                <p className="mt-5 line-clamp-3 text-sm/6 text-gray-600">{patient.content}</p>
              </div>
